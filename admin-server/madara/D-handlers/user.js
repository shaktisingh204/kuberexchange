...
module.exports.createUser = function (io, socket, request) {
   ...
   if (request.newUser.role == 'user') {
      ...
      User.findOne({
         ...
         User.findOne({
            ...
            if (dbAdmin.role == "manager") {
               ...
               var manager = dbAdmin._id;
               var master = dbAdmin._id;
               var subadmin = dbAdmin._id;
               var admin = dbAdmin._id;
            } else if (dbAdmin.role == "master") {
               console.log("master", dbAdmin.subadmin);
               var SubadminP = await User.findOne({ _id: dbAdmin._id }, { partnershipsetting: 1, commissionsetting: 1 })
               if (SubadminP) {
                  console.log("yes");
               } else {
                  console.log("no");
      ...
      if (request.newUser.role == "master") {
         if (request.details.role != 'subadmin' && request.details.role != 'admin') {
            socket.emit("create-user-success", {
               "message": "Not Authorized.",
               error: true
            });
      ...
      if (request.newUser.role == "manager") {
         if (request.details.role != 'master' && request.details.role != 'subadmin' && request.details.role != 'admin') {
            socket.emit("create-user-success", {
               "message": "Not Authorized.",
               error: true
            });
            ...
            User.findOne({
               ...
               if (userCheck) {
                  ...
                  var commissionsetting = [
                     {
                        sport_id: 4, sport_name: "cricket", commission: request.newUser.cricket_commission
                     },
                     {
                        sport_id: 1, sport_name: "soccer", commission: request.newUser.soccer_commission
                     },
                     {
                        sport_id: 2, sport_name: "tennis", commission: request.newUser.tennis_commission
                     },
                     {
                        sport_id: "c9", sport_name: "casino", commission: request.newUser.cricket_commission
                     }
                  ];

                  var partnershipsetting = [
                     {
                        sport_id: 4, sport_name: "cricket", partnership: request.newUser.cricket_partnership
                     },
                     {
                        sport_id: 1, sport_name: "soccer", partnership: request.newUser.soccer_partnership
                     },
                     {
                        sport_id: 2, sport_name: "tennis", partnership: request.newUser.tennis_partnership
                     },
                     {
                        sport_id: "c9", sport_name: "casino", partnership: request.newUser.cricket_partnership
                     }
                  ];
                  ...
                  if (dbAdmin.role == "master") {
                     ...
                     for (var k = 0; k < dbAdmin.partnershipsetting.length; k++) {
                        Ownprtnrsp[dbAdmin.partnershipsetting[k].sport_id] = request.newUser.cricket_partnership;
                        Owncmsn[dbAdmin.partnershipsetting[k].sport_id] = request.newUser.cricket_commission;
                        mstrprtnrsp[dbAdmin.partnershipsetting[k].sport_id] = dbAdmin.partnershipsetting[0].partnership - request.newUser.cricket_partnership;
                        mstrcmsn[dbAdmin.partnershipsetting[k].sport_id] = dbAdmin.commissionsetting[0].commission - request.newUser.cricket_commission;
                        if (SubadminP) {
                     ...
                     for (var k = 0; k < dbAdmin.partnershipsetting.length; k++) {
                        ...
                        mstrprtnrsp[dbAdmin.partnershipsetting[k].sport_id] = 0;
                        mstrcmsn[dbAdmin.partnershipsetting[k].sport_id] = 0;
                        sbadmnprtnrsp[dbAdmin.partnershipsetting[k].sport_id] = dbAdmin.partnershipsetting[0].partnership - request.newUser.cricket_partnership;
                        sbadmncmsn[dbAdmin.partnershipsetting[k].sport_id] = dbAdmin.commissionsetting[0].commission - request.newUser.cricket_commission;
                        admprtnrsp[dbAdmin.partnershipsetting[k].sport_id] = 100 - dbAdmin.partnershipsetting[k].partnership;
                        admcmsn[dbAdmin.partnershipsetting[k].sport_id] = 100 - dbAdmin.commissionsetting[k].commission;
                     }
                     ...
                     for (var k = 0; k < dbAdmin.partnershipsetting.length; k++) {
                        ...
                        sbadmnprtnrsp[dbAdmin.partnershipsetting[k].sport_id] = 0;
                        sbadmncmsn[dbAdmin.partnershipsetting[k].sport_id] = 0;
                        admprtnrsp[dbAdmin.partnershipsetting[k].sport_id] = 100 - request.newUser.cricket_partnership;
                        admcmsn[dbAdmin.partnershipsetting[k].sport_id] = 100 - request.newUser.cricket_commission;
                     }
                     var master = "";
                     var subadmin = "";
                     var admin = dbAdmin._id;
                  ...
                  if (request.newUser.role == "manager") {
                     ...
                     var Parentpartnership = [
                        {
                           sport_id: 4, sport_name: "cricket", Own: Ownprtnrsp['4'], master: mstrprtnrsp['4'], subadmin: sbadmnprtnrsp['4'], admin: admprtnrsp['4']
                        },
                        {
                           sport_id: 1, sport_name: "soccer", Own: Ownprtnrsp['1'], master: mstrprtnrsp['1'], subadmin: sbadmnprtnrsp['1'], admin: admprtnrsp['1']
                        },
                        {
                           sport_id: 2, sport_name: "tennis", Own: Ownprtnrsp['2'], master: mstrprtnrsp['2'], subadmin: sbadmnprtnrsp['2'], admin: admprtnrsp['2']
                        },
                        {
                           sport_id: 'c9', sport_name: "casino", Own: Ownprtnrsp['c9'], master: mstrprtnrsp['c9'], subadmin: sbadmnprtnrsp['c9'], admin: admprtnrsp['c9']
                        }
                     ];

                     var Parentcommission = [
                        {
                           sport_id: 4, sport_name: "cricket", Own: Owncmsn['4'], master: mstrcmsn['4'], subadmin: sbadmncmsn['4'], admin: admcmsn['4']
                        },
                        {
                           sport_id: 1, sport_name: "soccer", Own: Owncmsn['1'], master: mstrcmsn['1'], subadmin: sbadmncmsn['1'], admin: admcmsn['1']
                        },
                        {
                           sport_id: 2, sport_name: "tennis", Own: Owncmsn['2'], master: mstrcmsn['2'], subadmin: sbadmncmsn['2'], admin: admcmsn['2']
                        },
                        {
                           sport_id: 'c9', sport_name: "casino", Own: Owncmsn['c9'], master: mstrcmsn['c9'], subadmin: sbadmncmsn['c9'], admin: admcmsn['c9']
                        }
                     ];
                     ...
                     var Parentpartnership = [
                        {
                           sport_id: 4, sport_name: "cricket", Own: Ownprtnrsp['4'], subadmin: mstrprtnrsp['4'], admin: admprtnrsp['4']
                        },
                        {
                           sport_id: 1, sport_name: "soccer", Own: Ownprtnrsp['1'], subadmin: mstrprtnrsp['1'], admin: admprtnrsp['1']
                        },
                        {
                           sport_id: 2, sport_name: "tennis", Own: Ownprtnrsp['2'], subadmin: mstrprtnrsp['2'], admin: admprtnrsp['2']
                        },
                        {
                           sport_id: 'c9', sport_name: "casino", Own: Ownprtnrsp['c9'], subadmin: mstrprtnrsp['c9'], admin: admprtnrsp['c9']
                        }
                     ];

                     var Parentcommission = [
                        {
                           sport_id: 4, sport_name: "cricket", Own: Owncmsn['4'], subadmin: sbadmncmsn['4'], admin: admcmsn['4']
                        },
                        {
                           sport_id: 1, sport_name: "soccer", Own: Owncmsn['1'], subadmin: sbadmncmsn['1'], admin: admcmsn['1']
                        },
                        {
                           sport_id: 2, sport_name: "tennis", Own: Owncmsn['2'], subadmin: sbadmncmsn['2'], admin: admcmsn['2']
                        },
                        {
                           sport_id: 'c9', sport_name: "casino", Own: Owncmsn['c9'], subadmin: sbadmncmsn['c9'], admin: admcmsn['c9']
                        }
                     ];
                     ...
                     var Parentpartnership = [
                        {
                           sport_id: 4, sport_name: "cricket", Own: Ownprtnrsp['4'], admin: admprtnrsp['4']
                        },
                        {
                           sport_id: 1, sport_name: "soccer", Own: Ownprtnrsp['1'], admin: admprtnrsp['1']
                        },
                        {
                           sport_id: 2, sport_name: "tennis", Own: Ownprtnrsp['2'], admin: admprtnrsp['2']
                        },
                        {
                           sport_id: 'c9', sport_name: "casino", Own: Ownprtnrsp['c9'], admin: admprtnrsp['c9']
                        }
                     ];

                     var Parentcommission = [
                        {
                           sport_id: 4, sport_name: "cricket", Own: Owncmsn['4'], admin: admcmsn['4']
                        },
                        {
                           sport_id: 1, sport_name: "soccer", Own: Owncmsn['1'], admin: admcmsn['1']
                        },
                        {
                           sport_id: 2, sport_name: "tennis", Own: Owncmsn['2'], admin: admcmsn['2']
                        },
                        {
                           sport_id: 'c9', sport_name: "casino", Own: Owncmsn['c9'], admin: admcmsn['c9']
                        }
                     ];
...
module.exports.createPartner = function (io, socket, request) {
   // - validate request data
   // console.log(request);
   ...
   User.findOne({
      ...
      if (dbAdmin) {
         ...
         if (!dbAdmin.validTransPassword(request.details.transpassword)) {
            dbAdmin.loginAttempts += 1;
            logger.error('create-partner-success: Invalid Transaction password ' + request.details.username);
            // console.log('create-user-success: Invalid Transaction password');
         ...
         User.findOne({
            ...
            if (userCheck) {
               ...
               user.exposurelimit = 0;
               user.partnerWith = dbAdmin.username;
               user.casinobalance = 0;
...
module.exports.userlogin = function (io, socket, request) {
   ...
   User.findOne({
      ...
      if (user.role == "partner") {
         ...
         var ParentUser = await User.findOne({ username: user.partnerWith }, { _id: 1, hash: 1, token: 1, username: 1, role: 1, manager: 1, admin: 1, master: 1, subadmin: 1, status: 1, commissionsetting: 1, partnershipsetting: 1, ParentUser: 1, transctionpasswordstatus: 1 })
...
module.exports.updateMaintenancePage = function (io, socket, request) {
   // - validate request data
   ...
   User.findOne({
      ...
      if (!dbAdmin.validTransPassword(request.details.transpassword)) {
         ...
         socket.emit('maintenance-page-success', {
            "message": "Invalid Transaction password",
            error: true
         });
         return;
      ...
      const update = {
         maintenancepage: request.status,
      };
...
module.exports.changeUserPassword = function (io, socket, request) {
   // - validate request data
   // console.log(request);  
   ...
   User.findOne({
      ...
      User.findOne({
         ...
         result.setPassword(request.targetUser.password);
         result.settransPassword(request.targetUser.password);
...
module.exports.addBonus = (req, res) => {
   try {
...
module.exports.updateBonus = (req, res) => {
   try {
...
module.exports.updateBonusStatus = (req, res) => {
   try {
...
module.exports.searchUser = function (req, res) {
   ...
   User.findOne({
      ...
      if (getUser) {
         res.json({ response: getUser, error: false, "message": "Username Already Taken!" });
      } else {
         res.json({ response: [], error: true, "message": "" });
      }
   });
...
module.exports.updateStatus = async function (req, res) {
   ...
   User.findOne({
      ...
      var filter = {
         manager: req.body.targetUser.username,
      };

      if (req.body.targetUser.role == "master") {
         filter = {
            master: req.body.targetUser.username,
         };
      }

      if (req.body.targetUser.role == "subadmin") {
         filter = {
            subadmin: req.body.targetUser.username,
         };
      }

      if (req.body.targetUser.role == "admin") {
         filter = {
            admin: req.body.targetUser.username,
         };
      }
...
module.exports.getUserEvenets = async function (req, res) {
   ...
   User.findOne({
      ...
      if (dbAdmin) {
         // console.log(req.body);
         User.findOne({ username: req.body.targetUser.username, role: req.body.targetUser.role, }, { availableEventTypes: 1 })
            .then(async data => {
               if (data) {
                  // var response = {
                  //    parent:dbAdmin.availableEventTypes,
                  //    data
                  // }
                  res.json({ response: data, parent: dbAdmin.availableEventTypes, error: false, "message": "server response success" });
               }
               else {
...
module.exports.updateSportEvents = async function (req, res) {
   // - validate request data
   // console.log(req.body.status,req.body.status.cricket,req.body.status.soccer,req.body.status.tennis,req.body.status.casino,req.body.status.live_casino);
...
module.exports.getPartnerList = async function (req, res) {
   try {
      ...
      User.findOne({
         ...
         User.find(filter, { username: 1, role: 1 }).sort({
            username: 1
         }).exec(async function (err, getUser) {
   ...
   try {
      ...
      User.findOne({
         ...
         User.findOne({ username: req.body.targetUser.username.toUpperCase(), role: req.body.targetUser.role },
            {
               username: 1, balance: 1, manager: 1, master: 1, subadmin: 1, admin: 1, Parentrole: 1, availableAmount: 1, exposure: 1, limit: 1, manager: 1, ParentUser: 1
            }).then(async dbUser => {
               User.findOne({ username: dbUser.ParentUser, },
                  {
                     username: 1, balance: 1, manager: 1, master: 1, subadmin: 1, admin: 1, Parentrole: 1, ParentUser: 1, availableAmount: 1, exposure: 1, limit: 1
                  }).then(async dbMUser => {
                     ...
                     session.endSession();
                     logger.error('place-bet-error: DBError', error);
                     return res.json({ response: {}, error: true, "message": "Parent User Not Found" });
                  })
            }).catch(async error => {
               await session.abortTransaction();
               session.endSession();
         ...
         session.endSession();
         logger.error('place-bet-error: DBError', error);
         return res.json({ response: {}, error: true, "message": "Admin Not Found" });
      })
   } catch (error) {
      await session.abortTransaction();
      session.endSession();
