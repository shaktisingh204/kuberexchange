                ...
                User.find({deleted:false, status:'active', availableEventTypes:val.eventTypeId}, {username:1,role:1},  function(err, dbManagers){
                 ...
                 val.managerStatus[dbManagers[i].username] = true;
                       ...
                       /* if(dbManagers[i].role=='subadmin')
                        {
                 val.subadmins.unshift(dbManagers[i].username);
                 val.subadminStatus[dbManagers[i].username] = true;
                    
                        }

                        if(dbManagers[i].role=='master')
                        {
                 val.masters.unshift(dbManagers[i].username);
                 val.masterStatus[dbManagers[i].username] = true;
