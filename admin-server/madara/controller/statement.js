  ...
  try {
    ...
    await Market.findOne({ marketId: marketId, marketType: 'SESSION', "marketBook.status": 'CLOSED', deleted: false, userlog: 1 },
      { marketId: 1, marketBook: 1, marketName: 1, marketName: 1, marketType: 1, sessionResult: 1, eventId: 1, eventName: 1, competitionId: 1, competitionName: 1, eventTypeId: 1, eventTypeName: 1 }, async function (err, getMarket) {
        ...
        await Bet.distinct('userId', { 'result': { $ne: 'ACTIVE' }, "marketId": marketId, }, async function (err, betusers) {
          //return;
          if (!betusers) {
          ...
          for (var i = 0; i < betusers.length; i++) {
            (async function (userId, getMarket) {
              ...
              await Bet.find({ marketId: marketId, userId: userId, status: 'MATCHED', result: { $ne: 'ACTIVE' }, deleted: false }, {
          ...
          if (betusers.length > 0) {
            ...
            for (var i = 0; i < betusers.length; i++) {
              ...
              (async function (userId, index, callback) {
                ...
                console.log("betusers22", userId);
                await Log.find({
                  marketId: marketId, marketType: 'SESSION', ParentRole: "manager", remark: "RollBack", ParentId: userId, deleted: false, subAction: {
                    $in: ['AMOUNT_WON', 'AMOUNT_LOST']
                  },
                }, {
          ...
          if (betusers.length > 0) {
            ...
            for (var i = 0; i < betusers.length; i++) {
              ...
              (async function (userId, index, callback) {
                ...
                console.log("betusers22", userId);
                await Log.find({
                  marketId: marketId, ParentRole: "master", marketType: 'SESSION', remark: "RollBack", ParentId: userId, deleted: false, subAction: {
                    $in: ['AMOUNT_WON', 'AMOUNT_LOST']
                  },
                }, {
          ...
          if (betusers.length > 0) {
            ...
            for (var i = 0; i < betusers.length; i++) {
              ...
              (async function (userId, index, callback) {
                ...
                console.log("betusers22", userId);
                await Log.find({
                  marketId: marketId, marketType: 'SESSION', ParentRole: "subadmin", remark: "RollBack", ParentId: userId, deleted: false, subAction: {
                    $in: ['AMOUNT_WON', 'AMOUNT_LOST']
                  },
                }, {
                  username: 1, subAction: 1, logtype: 1, amount: 1, totalamount: 1, Partnerpercentage: 1
          ...
          if (betusers.length > 0) {
            ...
            for (var i = 0; i < betusers.length; i++) {
              ...
              (async function (userId, index, callback) {
                ...
                console.log("betusers22", userId);
                await Log.find({
                  marketId: marketId, marketType: 'SESSION', ParentRole: "admin", remark: "RollBack", ParentId: userId, deleted: false, subAction: {
                    $in: ['AMOUNT_WON', 'AMOUNT_LOST']
                  },
                }, {
                  username: 1, subAction: 1, logtype: 1, amount: 1, totalamount: 1, Partnerpercentage: 1
        ...
        if (typeof winnerId != 'undefined') {
          ...
          await Bet.distinct('userId', { 'result': { $ne: 'ACTIVE' }, "marketId": marketId, }, async function (err, betusers) {
            ...
            for (var i = 0; i < betusers.length; i++) {
              (async function (userId, getMarket) {
                console.log("betusers22", userId);
                await Bet.find({ marketId: marketId, userId: userId, status: 'MATCHED', 'result': { $ne: 'ACTIVE' }, deleted: false }, function (err, bets) {
                  if (bets) {
                    var winners = {};
          ...
          if (betusers.length > 0) {
            ...
            for (var i = 0; i < betusers.length; i++) {
              ...
              (async function (userId, index, callback) {
                ...
                console.log("betusers22", userId);
                await Log.find({
                  marketId: marketId, marketType: 'Special', ParentRole: "manager", remark: "RollBack", ParentId: userId, deleted: false, subAction: {
                    $in: ['AMOUNT_WON', 'AMOUNT_LOST']
                  },
                }, {
                  subAction: 1, amount: 1
          ...
          if (betusers.length > 0) {
            ...
            for (var i = 0; i < betusers.length; i++) {
              ...
              (async function (userId, index, callback) {
                ...
                console.log("betusers22", userId);
                await Log.find({
                  marketId: marketId, ParentRole: "master", remark: "RollBack", marketType: 'Special', ParentId: userId, deleted: false, subAction: {
                    $in: ['AMOUNT_WON', 'AMOUNT_LOST']
                  },
                }, {
                  username: 1, subAction: 1, logtype: 1, amount: 1, totalamount: 1, Partnerpercentage: 1
          ...
          if (betusers.length > 0) {
            ...
            for (var i = 0; i < betusers.length; i++) {
              ...
              (async function (userId, index, callback) {
                ...
                console.log("betusers22", userId);
                await Log.find({
                  marketId: marketId, marketType: 'Special', remark: "RollBack", ParentRole: "subadmin", ParentId: userId, deleted: false, subAction: {
                    $in: ['AMOUNT_WON', 'AMOUNT_LOST']
                  },
                }, {
          ...
          if (betusers.length > 0) {
            ...
            for (var i = 0; i < betusers.length; i++) {
              ...
              (async function (userId, index, callback) {
                ...
                console.log("betusers22", userId);
                await Log.find({
                  marketId: marketId, marketType: 'Special', remark: "RollBack", ParentRole: "admin", ParentId: userId, deleted: false, subAction: {
                    $in: ['AMOUNT_WON', 'AMOUNT_LOST']
                  },
                }, {
                  username: 1, subAction: 1, amount: 1, logtype: 1, totalamount: 1, Partnerpercentage: 1
