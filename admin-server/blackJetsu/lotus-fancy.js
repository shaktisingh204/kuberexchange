...
setInterval(function () {
  ...
  Market.find({
    ...
    dbMarket.forEach(function (element) {
      ...
      //   // if(element.eventId == "32475033"){
      //   //   console.log("32475033",error,response.body); 
      //   // }
      ...
      //       // console.log(elementall.nat,elementall.min,elementall.max,elementall.remark);
      //       var Fancy_Name = "Normal";
      ...
      //           // console.log(dbMarketcount.marketId+""+dbMarketcount.visibleStatus+""+dbMarketcount.visible,dbMarketcount.auto)
...
setInterval(function () {
  ...
  Market.find({
    ...
    dbMarket.forEach(function (element) {
      ...
      //   // if (eventId == 32475033) {
      //   //   //   if (!response) return;
      //   //   console.log("32475033", response.body);
      //   // }
      //   try {
      //     if (!response.body) {
            request('http://178.62.77.178:3006/api/get-fancy-bokmaker/' + eventId, function (error, response, body) {
