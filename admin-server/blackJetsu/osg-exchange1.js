        ...
        dbMarket.forEach(function (element) {
            ...
            request('http://172.105.37.170/api/v1/getMarketOdds?token=AnOH54xjqvZQjfzTEA3LsIghPLoXGAfOmzwrJmcI&market_id=' + marketId, function (error, response, body) {
                ...
                try {
                        ...
                        if (obj) {
                            ...
                            (function (market) {
                                Market.findOne({
                                    ...
                                    if (!dbMarket.score) {
                                        //dbMarket.score = 'https://score1.onlyscore.live/Scorebord?id=' + dbMarket.eventId;

                                    }

                                    // console.log(dbMarket.score)
                    ...
                    Market.updateMany(
                        { rateSource: 'OSGExchange', "eventTypeId": "1" },
                        {
                            $set:
                            {
