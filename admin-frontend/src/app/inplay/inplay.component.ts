...
export class InplayComponent implements OnInit, OnDestroy {
  ...
  constructor(private cdRef: ChangeDetectorRef, private loginService: LoginService,private cookie: CookieService, private socketService: SocketServiceService, private route: ActivatedRoute, private router: Router, private http: HttpClient, private sport: SportService, private toastr: ToastrService) {
  ...
  async ngOnInit() {
    // this.allSportsList = JSON.parse(sessionStorage.getItem('sportList'))
