...
export class MatchResultComponent implements OnInit {
  ...
  constructor(private locationBack: Location, private sport: SportService, private cookie: CookieService,private loginService: LoginService,
    private toastr: ToastrService, private reportService: ReportService,private router: Router,) { }
