...
export class UsersService {
  ...
  checkexistUser(id, data) {
    return this.http.post<any>(this.Base_Url + 'api/searchUser/' + id, data, { headers: this.reqHeader });
  }
  ...
  getUserBalance(id) {
    return this.http.post<any>(this.Base_Url + 'user/getUserBalance', { "userid": id }, { headers: this.reqHeader });
  }
