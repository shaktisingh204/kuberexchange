...
export class MatchRollbackComponent implements OnInit {
  ...
  constructor(private locationBack: Location, private sport: SportService,private router: Router, private cookie: CookieService,private loginService: LoginService,
