...
@Component({
  selector: 'app-ourvipcasino',
  templateUrl: './ourvipcasino.component.html',
  styleUrls: ['./ourvipcasino.component.scss']
})
export class OurvipcasinoComponent implements OnInit {
  ...
  casinos = [
    { name: 'All Casino', image: 'https://dataobj.ecoassetsservice.com/casino-icons/lc/teen20v1_green.gif' },
    { name: 'Teenpatti', image: 'https://dataobj.ecoassetsservice.com/casino-icons/lc/teen20v1_green.gif' },
  ];
